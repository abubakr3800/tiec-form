...
<body>
            ...
            <div class="col-lg-8">
                <div class="form-container p-5">
                    ...
                    <div class="text-center mb-5">
                        <h1 class="section-title" id="main-title">نظام التسجيل - TIEC</h1>
                        <p class="text-muted" id="subtitle">سجل الآن للحصول على خدماتنا المتميزة</p>
                    </div>
                    ...
                    <form id="registration-form" method="POST" action="process_registration.php" enctype="multipart/form-data">
                        ...
                        <div class="row mb-4">
                            <div class="col-12">
                                <h4 class="section-title" id="personal-info-title">
                                    <i class="fas fa-user"></i> المعلومات الشخصية
                                </h4>
                            </div>
                            
                            <div class="col-md-6 mb-3">
                                <label for="name" class="form-label" id="name-label">الاسم الكامل *</label>
                                <input type="text" class="form-control" id="name" name="name" required>
                            </div>
                            
                            <div class="col-md-6 mb-3">
                                <label for="national_id" class="form-label" id="national-id-label">الرقم القومي *</label>
                                <input type="text" class="form-control" id="national_id" name="national_id" required>
                            </div>
                            
                            <div class="col-md-6 mb-3">
                                <label for="governorate" class="form-label" id="governorate-label">المحافظة *</label>
                                <select class="form-select" id="governorate" name="governorate" required>
                                    <option value="" id="select-governorate">اختر المحافظة</option>
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="gender" class="form-label" id="gender-label">الجنس *</label>
                                <select class="form-select" id="gender" name="gender" required>
                                    <option value="" id="select-gender">اختر الجنس</option>
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="age" class="form-label" id="age-label">العمر *</label>
                                <input type="number" class="form-control" id="age" name="age" min="16" max="100" required>
                            </div>
                            
                            <div class="col-md-6 mb-3">
                                <label for="phone" class="form-label" id="phone-label">رقم الهاتف *</label>
                                <input type="tel" class="form-control" id="phone" name="phone" required>
                            </div>
                            
                            <div class="col-md-6 mb-3">
                                <label for="whatsapp" class="form-label" id="whatsapp-label">رقم الواتساب</label>
                        ...
                        <div class="row mb-4">
                            <div class="col-12">
                                <h4 class="section-title" id="education-title">
                                    <i class="fas fa-graduation-cap"></i> المعلومات التعليمية والمهنية
                                </h4>
                            </div>
                            
                            <div class="col-md-6 mb-3">
                                <label for="participant_type" class="form-label" id="participant-type-label">نوع المشارك *</label>
                                <select class="form-select" id="participant_type" name="participant_type" required>
                                    <option value="" id="select-participant-type">اختر نوع المشارك</option>
                                    <option value="student" id="student-option">طالب</option>
                                    <option value="employee" id="employee-option">موظف</option>
                                    <option value="other" id="other-option">أخرى</option>
                                </select>
                            </div>
                            
                            <div class="col-md-6 mb-3" id="university-field">
                                <label for="university" class="form-label" id="university-label">الجامعة</label>
                                <input type="text" class="form-control" id="university" name="university">
                            </div>
                            
                            <div class="col-md-6 mb-3" id="education-stage-field">
                                <label for="education_stage" class="form-label" id="education-stage-label">المرحلة التعليمية</label>
                                <select class="form-select" id="education_stage" name="education_stage">
                                    <option value="" id="select-education-stage">اختر المرحلة</option>
                            ...
                            <div class="col-md-6 mb-3" id="faculty-field">
                                <label for="faculty" class="form-label" id="faculty-label">الكلية</label>
                                <input type="text" class="form-control" id="faculty" name="faculty">
                            </div>
                            
                            <div class="col-md-6 mb-3" id="work-employer-field">
                                <label for="work_employer" class="form-label" id="work-employer-label">جهة العمل</label>
                                <input type="text" class="form-control" id="work_employer" name="work_employer">
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            <div class="col-12">
                                <h4 class="section-title" id="services-title">
                                    <i class="fas fa-cogs"></i> الخدمات المطلوبة
                                </h4>
                            </div>
                            
                            <div class="col-12 mb-3">
                                <label for="service_id" class="form-label" id="service-label">اختر الخدمة *</label>
                                <select class="form-select" id="service_id" name="service_id" required>
                                    <option value="" id="select-service">اختر الخدمة</option>
                        ...
                        <div class="row mb-4">
                            <div class="col-12">
                                <h4 class="section-title" id="training-title">
                                    <i class="fas fa-check-circle"></i> تأكيد التدريب
                                </h4>
                            </div>
                            
                            <div class="col-12 mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="training_confirmation" name="training_confirmation" value="1">
                                    <label class="form-check-label" for="training_confirmation" id="training-confirmation-label">
                                        أوافق على المشاركة في التدريب المطلوب
                                    </label>
                                </div>
                            </div>
                        </div>
                    ...
                    <!-- رمز QR -->
                    <div id="qr-container" class="qr-code-container hidden">
                        <h5 id="qr-title">رمز QR للتسجيل</h5>
                        <div id="qr-code"></div>
                        <p class="text-muted mt-3" id="qr-description">احفظ هذا الرمز للوصول السريع لبياناتك</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        function updateLanguage() {
            ...
            document.getElementById('training-confirmation-label').textContent = t.trainingConfirmationLabel;
        ...
        document.getElementById('participant_type').addEventListener('change', function() {
            ...
            const educationStageField = document.getElementById('education-stage-field');
            const facultyField = document.getElementById('faculty-field');
            const workEmployerField = document.getElementById('work-employer-field');
            ...
            .then(data => {
                ...
                if (data.success) {
                    ...
                    if (data.qr_code) {
                        ...
                        document.getElementById('qr-title').textContent = currentLang === 'ar' ? 'رمز QR للتسجيل' : 'QR Code for Registration';
                        document.getElementById('qr-description').textContent = currentLang === 'ar' ? 'احفظ هذا الرمز للوصول السريع لبياناتك' : 'Save this code for quick access to your data';
