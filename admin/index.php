...
if ($_SESSION['user_type'] !== 'admin') {
    header('Location: login.php?error=غير مصرح لك بالوصول لهذه الصفحة');
    exit();
}
...
$stats = [
    ...
    'total_questions' => $pdo->query("SELECT COUNT(*) FROM service_questions WHERE is_active = 1")->fetchColumn(),
    'total_admins' => $pdo->query("SELECT COUNT(*) FROM admins WHERE is_active = 1")->fetchColumn()
];
?>
...
<body>
    ...
    <div class="main-content" id="mainContent">
        <div class="container-fluid p-4">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h2 class="mb-1">مرحباً، <?= htmlspecialchars($_SESSION['user_name']) ?></h2>
                    <p class="text-muted">لوحة التحكم - نظام TIEC</p>
                </div>
                <div class="text-end">
                    <span class="badge bg-primary"><?= $_SESSION['admin_role'] ?? 'مشرف' ?></span>
                </div>
            </div>
            ...
            <div class="row mb-4">
                <div class="col-md-3">
                    <div class="stats-card p-4 text-center">
                        ...
                        <h3 class="mb-2"><?= number_format($stats['total_participants']) ?></h3>
                ...
                <div class="col-md-3">
                    <div class="stats-card p-4 text-center">
                        ...
                        <h3 class="mb-2"><?= number_format($stats['total_services']) ?></h3>
                ...
                <div class="col-md-3">
                    <div class="stats-card p-4 text-center">
                        ...
                        <h3 class="mb-2"><?= number_format($stats['total_questions']) ?></h3>
                        <p class="text-muted mb-0">الأسئلة النشطة</p>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="stats-card p-4 text-center">
                        <i class="fas fa-user-shield fa-2x text-info mb-3"></i>
                        <h3 class="mb-2"><?= number_format($stats['total_admins']) ?></h3>
                        <p class="text-muted mb-0">المشرفين النشطين</p>
                    </div>
                </div>
            </div>
            ...
            <div class="table-container p-4">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h4 class="mb-0">
                        <i class="fas fa-users"></i> المشاركين المسجلين
                    </h4>
                    <div>
