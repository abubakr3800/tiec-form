...
<head>
    ...
    <title>إدارة المشرفين - TIEC</title>
...
<body>
    ...
    <div class="main-content" id="mainContent">
        <div class="container-fluid p-4">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h2 class="mb-1">إدارة المشرفين</h2>
                    <p class="text-muted">إدارة حسابات المشرفين والصلاحيات</p>
                </div>
                <div>
            ...
            <div class="table-container p-4">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h4 class="mb-0">
                        <i class="fas fa-user-shield"></i> قائمة المشرفين
                    </h4>
                    <div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" onclick="saveAdmin()">حفظ المشرف</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="editAdminModal" tabindex="-1">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">تعديل المدير</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">إلغاء</button>
                    <button type="button" class="btn btn-primary" onclick="updateAdmin()">تحديث المدير</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
                ...
                columns: [
                    ...
                    { 
                        ...
                        render: function(data) {
                            return data === 'super_admin' ? 'مشرف رئيسي' : 'مشرف';
                        }
                    },
                    { 
                        data: 'is_active',
                        ...
                        render: function(data) {
                            return `
                                <div class="btn-group" role="group">
                                    <a href="view_admin.php?id=${data}" class="btn btn-sm btn-info">
                                        <i class="fas fa-eye"></i> عرض
                                    </a>
                                    <a href="view_admin_qr.php?id=${data}" class="btn btn-sm btn-primary">
                                        <i class="fas fa-qrcode"></i> QR
                                    </a>
                                    <button class="btn btn-sm btn-warning" onclick="editAdmin(${data})">
                                        <i class="fas fa-edit"></i> تعديل
                                    </button>
                                    <button class="btn btn-sm btn-danger" onclick="deleteAdmin(${data})">
        ...
        function saveAdmin() {
            ...
            .then(data => {
                if (data.success) {
                    Swal.fire('نجح', 'تم إضافة المشرف بنجاح', 'success');
            ...
            fetch(`get_admin.php?id=${id}`)
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        document.getElementById('edit_full_name').value = admin.name;
                        ...
                        Swal.fire('خطأ', data.message || 'حدث خطأ في جلب بيانات المشرف', 'error');
                    }
                })
                .catch(error => {
                    Swal.fire('خطأ', 'حدث خطأ في الاتصال', 'error');
        ...
        function updateAdmin() {
            ...
            .then(data => {
                if (data.success) {
                    Swal.fire('نجح', 'تم تحديث المشرف بنجاح', 'success');
        ...
        function exportData() {
            $('#admins-table').DataTable().button('csv').trigger();
        }
    </script>
</body>
</html> 